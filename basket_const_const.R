...
use_virtualenv("~/tf_petya_venv/", required = TRUE)
  ...
  ## Train/Test setup
  Ktrain <- 400000 # Size of training data
  Ktest <- 40000 # Size of test data
  epochs <- 100
  batch_size <- 256
...
### -------------------- 0. Functions
 ...
 #hist(fin_theory, main = paste("Payoff net of Hedges - MC Strategy, rho =", rho), xlim = c(-10, 10), xlab = "Net Payoff", breaks = 20)
  ...
  plot_path <- paste0("/Users/martonzorenyi/Downloads/basket_payoff_rho", rho, "_v11.pdf")
  ...
  # 1. Define the output path
  plot_path <- paste0("/Users/martonzorenyi/Downloads/basket_hedge_over_time_rho", rho, "_v11.pdf")
  ...
  # 1. Define the output path
  plot_path <- paste0("/Users/martonzorenyi/Downloads/basket_hedging_portfolio_over_time_rho", rho, "_v11.pdf")
  ...
  # 1. Define the output path
  plot_path <- paste0("/Users/martonzorenyi/Downloads/basket_qqplot_rho", rho, "_v12.pdf")
