...
hedge_over_time(path_num = 8, showplot = T, rho = rho)
...
mean(fin_nn <- final_hedge_pos - final_payoffs)
...
print("Quantiles:")
print("NN:")
print(quantile(fin_nn, probs = c(0.05, 0.95)))
print("Theory:")
print(quantile(fin_theory, probs = c(0.05, 0.95)))
print("Expected shortfall:")
print(data.frame(NN = expected_shortfall_nn, THEORY = expected_shortfall_theory))
par(mfrow = c(1,2))
